  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 pt-16 pb-20">
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        >
          PipBot is a floating assistant that feels less like software and more like presence. It manages email, calendars, research, and tasks while staying aware of what you're doing. Screen sharing is optional. No tabs. No switching. Just ask.
        </motion.p>
