  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 pt-16 pb-20">
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        >
          PipBot is a desktop AI that floats on your screen, understands what you're looking at, 
          and helps you get things done. No browser tabs. No context switching. Just ask.
        </motion.p>
